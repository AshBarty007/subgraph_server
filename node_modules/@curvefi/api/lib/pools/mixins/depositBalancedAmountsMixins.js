            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, _depositBalancedAmounts(poolBalances, walletBalances, this.underlyingDecimals)];
                }
            });
        });
    },
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        walletBalancesUSD = walletBalances.map(function (b, i) { return b * prices[i]; });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        walletBalances = _b.apply(_a, [_c.sent()]).map(Number);
                        return [2 /*return*/, _depositBalancedAmounts(poolBalances, walletBalances, this.wrappedDecimals)];
                }
            });
        });
    },
