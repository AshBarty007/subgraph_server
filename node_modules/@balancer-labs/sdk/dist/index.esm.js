...
import { SwapTypes, PoolFilter, SOR, StablePool, ZERO, WeightedPool, MetaStablePool, PhantomStablePool, LinearPool, parseToPoolsDict, getSpotPriceAfterSwapForPath } from '@balancer-labs/sor';
...
class Sor extends SOR {
    ...
    static getSorNetworkConfig(network) {
        ...
        return {
            ...
            bbausd: (_c = network.pools) === null || _c === void 0 ? void 0 : _c.bbausd,
            wethBBausd: (_d = network.pools) === null || _d === void 0 ? void 0 : _d.wethBBausd,
            lbpRaisingTokens: (_e = network.addresses.tokens) === null || _e === void 0 ? void 0 : _e.lbpRaisingTokens,
        };
    }
...
function decorateSorSwapInfo(swapInfo) {
...
class Swaps {
     ...
     */
    buildSwap({ userAddress, swapInfo, kind, deadline, maxSlippage, }) {
        if (!this.chainId)
...
class StablePoolLiquidity {
    calcTotal(tokenBalances, tokenDecimals, tokenPriceRates, tokenPrices) {
        // TODO implementation
...
class Stable {
    constructor(liquidityCalculatorConcern = StablePoolLiquidity, spotPriceCalculatorConcern = StablePoolSpotPrice) {
        this.liquidityCalculatorConcern = liquidityCalculatorConcern;
...
class WeightedPoolLiquidity {
    calcTotal(tokenBalances, tokenDecimals, tokenPriceRates, tokenPrices, someOtherInput) {
        // TODO implementation
        console.log(tokenBalances, tokenDecimals, tokenPriceRates, tokenPrices, someOtherInput);
        throw new Error('To be implemented');
    }
}
...
class Weighted {
    constructor(liquidityCalculatorConcern = WeightedPoolLiquidity, spotPriceCalculatorConcern = WeightedPoolSpotPrice) {
        this.liquidityCalculatorConcern = liquidityCalculatorConcern;
        this.spotPriceCalculatorConcern = spotPriceCalculatorConcern;
        this.liquidityCalculator = new this.liquidityCalculatorConcern();
        this.spotPriceCalculator = new this.spotPriceCalculatorConcern();
...
class MetaStable {
    constructor(liquidityCalculatorConcern = MetaStablePoolLiquidity, spotPriceCalculatorConcern = MetaStablePoolSpotPrice) {
        this.liquidityCalculatorConcern = liquidityCalculatorConcern;
        this.spotPriceCalculatorConcern = spotPriceCalculatorConcern;
        this.liquidityCalculator = new this.liquidityCalculatorConcern();
        this.spotPriceCalculator = new this.spotPriceCalculatorConcern();
...
class StablePhantom {
    constructor(liquidityCalculatorConcern = StablePhantomPoolLiquidity, spotPriceCalculatorConcern = StablePhantomPoolSpotPrice) {
        this.liquidityCalculatorConcern = liquidityCalculatorConcern;
        this.spotPriceCalculatorConcern = spotPriceCalculatorConcern;
        this.liquidityCalculator = new this.liquidityCalculatorConcern();
        this.spotPriceCalculator = new this.spotPriceCalculatorConcern();
...
class Linear {
    constructor(liquidityCalculatorConcern = LinearPoolLiquidity, spotPriceCalculatorConcern = LinearPoolSpotPrice) {
        this.liquidityCalculatorConcern = liquidityCalculatorConcern;
        this.spotPriceCalculatorConcern = spotPriceCalculatorConcern;
        this.liquidityCalculator = new this.liquidityCalculatorConcern();
        this.spotPriceCalculator = new this.spotPriceCalculatorConcern();
...
class BalancerSDK {
    constructor(config, sor = new Sor(config), subgraph = new Subgraph(config), pools = new Pools(config)) {
        this.config = config;
        this.sor = sor;
