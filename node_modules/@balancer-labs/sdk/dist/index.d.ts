...
declare class Swaps {
     ...
     */
    buildSwap({ userAddress, swapInfo, kind, deadline, maxSlippage, }: BuildTransactionParameters): SwapAttributes;
    /**
...
declare class StablePoolLiquidity implements LiquidityConcern {
    calcTotal(tokenBalances: BigNumberish[], tokenDecimals: number[], tokenPriceRates: BigNumberish[], tokenPrices: (number | null)[]): string;
}
...
interface PoolType$1 {
    liquidityCalculator: LiquidityConcern;
    spotPriceCalculator: SpotPriceConcern;
}

declare class Stable implements PoolType$1 {
    private liquidityCalculatorConcern;
    private spotPriceCalculatorConcern;
    liquidityCalculator: LiquidityConcern;
    spotPriceCalculator: SpotPriceConcern;
    constructor(liquidityCalculatorConcern?: typeof StablePoolLiquidity, spotPriceCalculatorConcern?: typeof StablePoolSpotPrice);
}

declare class WeightedPoolLiquidity implements LiquidityConcern {
    calcTotal(tokenBalances: BigNumberish[], tokenDecimals: number[], tokenPriceRates: BigNumberish[], tokenPrices: (number | null)[], someOtherInput: number): string;
}
...
declare class Weighted implements PoolType$1 {
    private liquidityCalculatorConcern;
    private spotPriceCalculatorConcern;
    liquidityCalculator: LiquidityConcern;
    spotPriceCalculator: SpotPriceConcern;
    constructor(liquidityCalculatorConcern?: typeof WeightedPoolLiquidity, spotPriceCalculatorConcern?: typeof WeightedPoolSpotPrice);
}
...
declare class MetaStable implements PoolType$1 {
    private liquidityCalculatorConcern;
    private spotPriceCalculatorConcern;
    liquidityCalculator: LiquidityConcern;
    spotPriceCalculator: SpotPriceConcern;
    constructor(liquidityCalculatorConcern?: typeof MetaStablePoolLiquidity, spotPriceCalculatorConcern?: typeof MetaStablePoolSpotPrice);
}
...
declare class StablePhantom implements PoolType$1 {
    private liquidityCalculatorConcern;
    private spotPriceCalculatorConcern;
    liquidityCalculator: LiquidityConcern;
    spotPriceCalculator: SpotPriceConcern;
    constructor(liquidityCalculatorConcern?: typeof StablePhantomPoolLiquidity, spotPriceCalculatorConcern?: typeof StablePhantomPoolSpotPrice);
}
...
declare class Linear implements PoolType$1 {
    private liquidityCalculatorConcern;
    private spotPriceCalculatorConcern;
    liquidityCalculator: LiquidityConcern;
    spotPriceCalculator: SpotPriceConcern;
    constructor(liquidityCalculatorConcern?: typeof LinearPoolLiquidity, spotPriceCalculatorConcern?: typeof LinearPoolSpotPrice);
}
...
declare class Pools {
    ...
    static from(pool: SubgraphPoolBase): Weighted | Stable | MetaStable | StablePhantom | Linear;
}
...
declare class BalancerSDK implements BalancerSDKRoot {
    ...
    constructor(config: BalancerSdkConfig, sor?: Sor, subgraph?: Subgraph, pools?: Pools);
...
export { AaveHelpers, Account, AssetHelpers, BalancerError, BalancerErrorCode, BalancerErrors, BalancerMinterAuthorization, BalancerNetworkConfig, BalancerSDK, BalancerSDKRoot, BalancerSdkConfig, BalancerSdkSorConfig, BatchSwap, BatchSwapStep, BuildTransactionParameters, EncodeBatchSwapInput, EncodeExitPoolInput, EncodeUnwrapAaveStaticTokenInput, ExitAndBatchSwapInput, ExitPoolData, ExitPoolRequest, FetchPoolsInput, FindRouteParameters, FundManagement, JoinPoolRequest, ManagedPoolEncoder, Network, OutputReference, PoolBalanceOp, PoolBalanceOpKind, PoolReference, PoolSpecialization, PoolType, Pools, QuerySimpleFlashSwapParameters, QuerySimpleFlashSwapResponse, QueryWithSorInput, QueryWithSorOutput, Relayer, RelayerAction, RelayerAuthorization, SimpleFlashSwapParameters, SingleSwap, Sor, StablePhantomPoolJoinKind, StablePoolEncoder, StablePoolExitKind, StablePoolJoinKind, Subgraph, Swap, SwapAttributes, SwapInput, SwapTransactionRequest, SwapType, Swaps, TransactionData, UserBalanceOp, UserBalanceOpKind, WeightedPoolEncoder, WeightedPoolExitKind, WeightedPoolJoinKind, accountToAddress, getLimitsForSlippage, getPoolAddress, getPoolNonce, getPoolSpecialization, isNormalizedWeights, isSameAddress, signPermit, splitPoolId, toNormalizedWeights };
